...
const FlipBar = (props) => {
  ...
  return (
    <div
      className={`w-[100%] h-screen border-2 text-black bg-white  top-[65px] ${
    ...
    >
      <div className="flex flex-col">
        ...
        <div className="min-h-[20%] flex flex-col gap-4 mt-2 ">
          <Link
            to="/user/dashboard"
            className="flex flex-row items-center gap-4 p-2 pl-4 cursor-pointer"
          >
            <div className="bg-blue-600 w-9 h-9 flex justify-center items-center rounded-full p-2">
              <BsSendDashFill className="text-white" />
            </div>
          ...
          {/* <div className="flex flex-row gap-4 p-2  pl-4 ">
            <button type="button" onClick={handleLogout} className="text-white bg-blue-500 hover:bg-[#3065d8] p-2    rounded-md">
              <LogoutIcon /> Logout
            </button>
          </div> */}
          ...
          {/* <div className="flex flex-row gap-4 p-2  pl-4 ">
            <button type="button"  className="text-white bg-red-600 hover:bg-[#ec090a] p-2  rounded-md">
              <DeleteIcon /> Delete Account
            </button>
          </div> */}
