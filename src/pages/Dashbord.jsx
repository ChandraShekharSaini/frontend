...
const Dasbord = () => {
  ...
  useEffect(() => {
    ...
    const videoHistory = async (e) => {
      ...
      try {
        ...
        const response = await fetch(`https://vidtrim-backend-vercel.vercel.app/api/compressed-video/video-history/${currentUser._id}`, {
          method: "GET",
          headers: {
  ...
  const deleteVideo = async (id) => {
    ...
    try {
      ...
      const response = await fetch(`https://vidtrim-backend-vercel.vercel.app/api/compressed-video/delte-video/${id}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
        },
